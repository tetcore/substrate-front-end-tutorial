...
const getKeys = {
  ...
  params: [(0, _param.default)('prefix', 'StorageKey'), (0, _param.default)('block', 'Hash', {
    isOptional: true
  })],
...
const getChildKeys = {
  ...
  params: [(0, _param.default)('childStorageKey', 'StorageKey'), (0, _param.default)('prefix', 'StorageKey'), (0, _param.default)('block', 'Hash', {
    isOptional: true
  })],
  // @ts-ignore The Vec<> wrap is fine
  type: 'Vec<StorageKey>'
...
const getChildStorage = {
  ...
  params: [(0, _param.default)('childStorageKey', 'StorageKey'), (0, _param.default)('key', 'StorageKey'), (0, _param.default)('block', 'Hash', {
    isOptional: true
  })],
  type: 'StorageData'
};
...
const queryStorage = {
  ...
  (0, _param.default)('keys', 'Vec<StorageKey>'), (0, _param.default)('startBlock', 'Hash'), (0, _param.default)('block', 'Hash', {
    isOptional: true
  })],
  // @ts-ignore The Vec<> wrap is fine
...
const subscribeStorage = {
  ...
  params: [// @ts-ignore The Vec<> wrap is fine
  (0, _param.default)('keys', 'Vec<StorageKey>')],
