...
class ModuleMetadata extends _Struct.default {
  constructor(value) {
    super({
      ...
      storage: _Option.default.with(_Vector.default.with(_Storage.StorageEntryMetadata)),
      ...
      constants: _Vector.default.with(_Constants.ModuleConstantMetadata)
    }, value);
  }
  /**
...
class MetadataV6 extends _Struct.default {
  ...
  get constantNames() {
    return this.modules.map(mod => mod.constants.map(c => c.type.toString()));
  }
  ...
  getUniqTypes(throwError) {
    const types = (0, _util.flattenUniq)([this.callNames, this.constantNames, this.eventNames, this.storageNames]);
