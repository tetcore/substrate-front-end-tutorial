...
describe('Method', () => {
  ...
  it('handles decoding correctly (bare)', () => {
    expect(new _Method.default({
      args: [],
      callIndex: [5, 1] // balances.setBalance

    }).toU8a()).toEqual(new Uint8Array([5, 1, 0, 0, 0]));
  });
  it('handles creation from a hex value properly', () => {
    expect(new _Method.default('0x0501').toU8a()).toEqual(new Uint8Array([5, 1, 0, 0, 0])); // balances.setBalance
  });
  describe('hasOrigin', () => {
    const test = {
      args: [],
    ...
    it('is false with no arguments', () => {
      expect(new _Method.default(test, {
        args: []
