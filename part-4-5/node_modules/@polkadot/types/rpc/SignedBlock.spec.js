...
var _SignedBlock2 = _interopRequireDefault(require("./SignedBlock"));
...
describe('SignedBlock', () => {
  ...
  it('decodes a full block', () => {
    const s = new _SignedBlock2.default(_SignedBlock.default.result);
  ...
  describe('extrinsics', () => {
    it('can decode immortals', () => {
      const s = new _SignedBlock2.default(_SignedBlock004Immortal.default.result);
    ...
    it('can decode mortals', () => {
      const s = new _SignedBlock2.default(_SignedBlock004Mortal.default.result);
