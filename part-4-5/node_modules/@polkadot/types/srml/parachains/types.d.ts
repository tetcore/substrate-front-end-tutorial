...
declare type _AvailabilityVote = [SessionKey, CollatorSignature];
export interface AvailabilityVote extends Codec, _AvailabilityVote {
}
declare type _BalanceUpload = [AccountId, u64];
...
declare type _EgressQueueRoot = [ParaId, Hash];
