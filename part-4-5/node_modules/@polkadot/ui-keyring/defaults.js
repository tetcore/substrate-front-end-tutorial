...
const accountKey = address => "".concat(ACCOUNT_PREFIX).concat(toHex(address));

exports.accountKey = accountKey;

const addressKey = address => "".concat(ADDRESS_PREFIX).concat(toHex(address));

exports.addressKey = addressKey;

const contractKey = address => "".concat(CONTRACT_PREFIX).concat(toHex(address));

exports.contractKey = contractKey;
const accountRegex = new RegExp("^".concat(ACCOUNT_PREFIX, "0x[0-9a-f]*"), '');
exports.accountRegex = accountRegex;
const addressRegex = new RegExp("^".concat(ADDRESS_PREFIX, "0x[0-9a-f]*"), '');
exports.addressRegex = addressRegex;
const contractRegex = new RegExp("^".concat(CONTRACT_PREFIX, "0x[0-9a-f]*"), '');
